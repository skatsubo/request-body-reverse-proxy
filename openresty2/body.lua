...
-- High value to avoid "a client request body is buffered to a temporary file" which happens when chunk_size is small
-- Bear in mind that client_body_buffer_size has no effect when chunk_size is set
-- https://github.com/openresty/lua-resty-upload/blob/a05e91d3f0f3eead6dc589ff1253b9d8435b521b/lib/resty/upload.lua#L114-L117
-- https://github.com/openresty/lua-nginx-module?tab=readme-ov-file#ngxreqinit_body
local chunk_size = ngx.var.chunk_size
